...
public final class RpcRequests {
  ...
  public interface AppendEntriesResponseOrBuilder extends
    ...
    /**
     * <code>optional double backpressure_score = 190;</code>
     */
    boolean hasBackpressureScore();
    /**
     * <code>optional double backpressure_score = 190;</code>
     */
    double getBackpressureScore();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 1521: {
              bitField0_ |= 0x00000010;
              backpressureScore_ = input.readDouble();
              break;
            }
          }
        }
    ...
    public static final int BACKPRESSURE_SCORE_FIELD_NUMBER = 190;
    private double backpressureScore_;
    /**
     * <code>optional double backpressure_score = 190;</code>
     */
    public boolean hasBackpressureScore() {
      return ((bitField0_ & 0x00000010) == 0x00000010);
    }
    /**
     * <code>optional double backpressure_score = 190;</code>
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000010) == 0x00000010)) {
        output.writeDouble(190, backpressureScore_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000010) == 0x00000010)) {
        size += com.google.protobuf.CodedOutputStream
          .computeDoubleSize(190, backpressureScore_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      result = result && (hasBackpressureScore() == other.hasBackpressureScore());
      if (hasBackpressureScore()) {
        result = result && (
            java.lang.Double.doubleToLongBits(getBackpressureScore())
            == java.lang.Double.doubleToLongBits(
                other.getBackpressureScore()));
      }
      result = result && unknownFields.equals(other.unknownFields);
      return result;
    }
    ...
    public int hashCode() {
      ...
      if (hasBackpressureScore()) {
        hash = (37 * hash) + BACKPRESSURE_SCORE_FIELD_NUMBER;
        hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
            java.lang.Double.doubleToLongBits(getBackpressureScore()));
      }
      hash = (29 * hash) + unknownFields.hashCode();
    ...
    public static final class Builder extends
      ...
      public com.alipay.sofa.jraft.rpc.RpcRequests.AppendEntriesResponse buildPartial() {
        ...
        result.backpressureScore_ = backpressureScore_;
        result.bitField0_ = to_bitField0_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(com.alipay.sofa.jraft.rpc.RpcRequests.AppendEntriesResponse other) {
        ...
        if (other.hasBackpressureScore()) {
          setBackpressureScore(other.getBackpressureScore());
        }
        this.mergeUnknownFields(other.unknownFields);
        onChanged();
        return this;
       ...
       * <code>optional double backpressure_score = 190;</code>
       */
      public Builder setBackpressureScore(double value) {
        bitField0_ |= 0x00000010;
        backpressureScore_ = value;
        onChanged();
        return this;
      }
      /**
       * <code>optional double backpressure_score = 190;</code>
       */
      public Builder clearBackpressureScore() {
        bitField0_ = (bitField0_ & ~0x00000010);
        backpressureScore_ = 0D;
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ted_index\030\010 \002(\003\022\014\n\004data\030\t \001(\014\"\230\001\n\025Append" +
      "EntriesResponse\022\014\n\004term\030\001 \002(\003\022\017\n\007success" +
      "\030\002 \002(\010\022\026\n\016last_log_index\030\003 \001(\003\022+\n\rerrorR" +
      "esponse\030c \001(\0132\024.jraft.ErrorResponse\022\033\n\022b" +
      "ackpressure_score\030\276\001 \001(\001\"i\n\016GetFileReque" +
      ...
      "artly\030\005 \001(\010\"l\n\017GetFileResponse\022\013\n\003eof\030\001 " +
      "\002(\010\022\014\n\004data\030\002 \002(\014\022\021\n\tread_size\030\003 \001(\003\022+\n\r" +
      "errorResponse\030c \001(\0132\024.jraft.ErrorRespons" +
      "e\"Y\n\020ReadIndexRequest\022\020\n\010group_id\030\001 \002(\t\022" +
      "\021\n\tserver_id\030\002 \002(\t\022\017\n\007entries\030\003 \003(\014\022\017\n\007p" +
      "eer_id\030\004 \001(\t\"`\n\021ReadIndexResponse\022\r\n\005ind" +
      "ex\030\001 \002(\003\022\017\n\007success\030\002 \002(\010\022+\n\rerrorRespon" +
      "se\030c \001(\0132\024.jraft.ErrorResponseB(\n\031com.al" +
      "ipay.sofa.jraft.rpcB\013RpcRequests"
    };
    ...
    internal_static_jraft_AppendEntriesResponse_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_jraft_AppendEntriesResponse_descriptor,
        new java.lang.String[] { "Term", "Success", "LastLogIndex", "ErrorResponse", "BackpressureScore", });
    internal_static_jraft_GetFileRequest_descriptor =
